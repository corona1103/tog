...
- [x] **Step 3: 添加首页入口交互**
  ...
  将“上周学习周报已生成”置于首页顶部；首页提供学习趋势和学习方法入口，点击可进入学习页或打开方法详情；点击提醒授权按钮显示“已开启周报提醒”的模拟状态。
...
- [x] **Step 6: 实现学习方法与知识图谱**

  展示“错题周周清”“薄弱点打透”“单词周周升”三个方法模块，并展示数理化生四个学科的知识点点亮数量；点击方法或学科打开详情抽屉。
